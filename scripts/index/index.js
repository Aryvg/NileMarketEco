...
//To run it, you will use `npx serve .` in the terminal and open the provided localhost URL in your browser. Make sure your backend server is running on https://nilemarketbackend.onrender.com for the API calls to work correctly.
